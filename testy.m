...
%21. Zaladunek detalu w LU
p = p.wykonajSterowanie(Sterowanie(3,5,2,1));
lista = p.listaDostepnychSterowan();
assert(length(lista) == 1,'Test Failed: zla dlugosc listy dostepnych zadan');

assert(lista(1).typ_zadania() == 2, 'Test Failed: Zly typ zadania'); % Tylko jedno zadanie do zrobienia.
assert(lista(1).numer_maszyny() == 5, 'Test Failed: Zly nr maszyny');
assert(lista(1).numer_zadania() == 2, 'Test Failed: Zly nr zadania');
assert(lista(1).etap_zadania() == 1, 'Test Failed: Zly etap zadania');

%21. Transport do M2
p = p.wykonajSterowanie(Sterowanie(2,5,2,1));
lista = p.listaDostepnychSterowan();
assert(length(lista) == 1,'Test Failed: zla dlugosc listy dostepnych zadan');
...
p = p.wykonajSterowanie(Sterowanie(2,1,2,1));
lista = p.listaDostepnychSterowan();
assert(length(lista) == 1,'Test Failed: zla dlugosc listy dostepnych zadan');

assert(lista(1).typ_zadania() == 1, 'Test Failed: Zly typ zadania'); % Tylko jedno zadanie do zrobienia.
assert(lista(1).numer_maszyny() == 2, 'Test Failed: Zly nr maszyny');
assert(lista(1).numer_zadania() == 2, 'Test Failed: Zly nr zadania');
assert(lista(1).etap_zadania() == 1, 'Test Failed: Zly etap zadania');

%22 Zaladunek na maszyne M2
p = p.wykonajSterowanie(Sterowanie(1,2,2,1));
lista = p.listaDostepnychSterowan();
assert(length(lista) == 1,'Test Failed: zla dlugosc listy dostepnych zadan');

assert(lista(1).typ_zadania() == 4, 'Test Failed: Zly typ zadania'); % Tylko jedno zadanie do zrobienia.
assert(lista(1).numer_maszyny() == 2, 'Test Failed: Zly nr maszyny');
assert(lista(1).numer_zadania() == 2, 'Test Failed: Zly nr zadania');
assert(lista(1).etap_zadania() == 1, 'Test Failed: Zly etap zadania');
